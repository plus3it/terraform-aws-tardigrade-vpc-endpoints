...
**Commit Delta**: [Change from 6.1.0 release](https://github.com/plus3it/terraform-aws-tardigrade-vpc-endpoints/compare/6.1.0...7.0.0)

**Summary**:

*   Bumps min version of AWS provider to v6
